...
const GEAR: Record<number, Gear> = {
  1: {
    ...
    equipped: {
      head: { id: 12640, name: 'Lionheart Helm', quality: 4, ilvl: 63, icon: 'inv_helmet_21', stats: { strength: 18, agility: 16 } },
      neck: { id: 18404, name: 'Onyxia Tooth Pendant', quality: 3, ilvl: 62, icon: 'inv_jewelry_necklace_13', stats: { agility: 12, stamina: 12 } },
      shoulder: { id: 16963, name: 'Bloodfang Spaulders', quality: 4, ilvl: 76, icon: 'inv_shoulder_15', stats: { agility: 23, stamina: 20 } },
      back: { id: 18541, name: 'Puissant Cape', quality: 3, ilvl: 63, icon: 'inv_misc_cape_11', stats: { stamina: 14 } },
      chest: { id: 16966, name: 'Bloodfang Chestpiece', quality: 4, ilvl: 76, icon: 'inv_chest_chain_15', stats: { agility: 28, stamina: 26 } },
      wrist: { id: 19866, name: 'Wristguards of Stability', quality: 3, ilvl: 63, icon: 'inv_bracer_09', stats: { strength: 24 } },
      hands: { id: 16965, name: 'Bloodfang Gloves', quality: 4, ilvl: 76, icon: 'inv_gauntlets_23', stats: { agility: 21, stamina: 18 } },
      waist: { id: 19137, name: 'Onslaught Girdle', quality: 4, ilvl: 71, icon: 'inv_belt_27', stats: { strength: 31, stamina: 11 } },
      legs: { id: 16962, name: 'Bloodfang Pants', quality: 4, ilvl: 76, icon: 'inv_pants_08', stats: { agility: 30, stamina: 28 } },
      feet: { id: 16965, name: 'Chromatic Boots', quality: 4, ilvl: 71, icon: 'inv_boots_plate_05', stats: { strength: 20, stamina: 20 } },
      finger1: { id: 17063, name: 'Band of Accuria', quality: 4, ilvl: 75, icon: 'inv_jewelry_ring_16', stats: { strength: 16 } },
      trinket1: { id: 12930, name: 'Briarwood Reed', quality: 3, ilvl: 60, icon: 'inv_misc_branch_01', stats: {} },
      mainhand: { id: 17182, name: 'Sulfuras, Hand of Ragnaros', quality: 5, ilvl: 80, icon: 'inv_hammer_unique_sulfuras', stats: { strength: 30, stamina: 30 }, weapon: { min: 223, max: 372, speed: 3.7 } },
  ...
  3: {
    ...
    equipped: {
      head: { id: 16919, name: 'Robes of Transcendence', quality: 4, ilvl: 76, icon: 'inv_chest_cloth_38', stats: { intellect: 30 } },
      mainhand: { id: 17103, name: 'Aurastone Hammer', quality: 4, ilvl: 71, icon: 'inv_hammer_10', stats: { intellect: 12 }, weapon: { min: 61, max: 114, speed: 2.9 } },
    },
    talents: [],
  },
};
