...
export const DRUID_EFFECTS: Effect[] = [
  ...
  },
  {
    ...
    providers: [
      { classId: 'druid', specs: [FERAL], talent: { tree: 'Feral Combat', name: 'Leader of the Pack' }, choice: FORM },
    ],
  ...
  },
  {
    ...
    providers: [
      { classId: 'druid', specs: [BALANCE], talent: { tree: 'Balance', name: 'Moonkin Form' }, choice: FORM },
    ],
  ...
  },
  {
    ...
    providers: [{ classId: 'druid', specs: [BALANCE], talent: { tree: 'Balance', name: 'Insect Swarm' } }],
  ...
  },
  {
    ...
    providers: [{ classId: 'druid', specs: ANY }],
    exclusiveWith: ['demoralizing-shout', 'curse-of-weakness'],
    forever: {
      status: 'changed',
  ...
  },
  {
    ...
    providers: [{ classId: 'druid', specs: ANY }],
    forever: { status: 'changed', note: 'Improved Thorns was cut from the Balance tree.' },
  },
  {
    id: 'innervate',
    name: 'Innervate',
  ...
  },
  {
    ...
    providers: [{ classId: 'druid', specs: ANY }],
    forever: { status: 'same', note: 'Keeps its 30 min cooldown. The new Revive covers out-of-combat resurrection.' },
  },
  {
    id: 'revive',
    name: 'Revive',
    ...
    categories: ['misc-utility'],
    providers: [{ classId: 'druid', specs: ANY }],
    forever: { status: 'new', note: 'New out-of-combat resurrection on a 10 sec cast, separate from Rebirth.' },
  },
  {
    id: 'tranquility',
    name: 'Tranquility',
  ...
  },
  {
    ...
    providers: [
      { classId: 'druid', specs: [FERAL], talent: { tree: 'Feral Combat', name: 'Feral Charge' } },
    ],
  ...
  },
  {
    ...
    providers: [{ classId: 'druid', specs: ANY }],
    forever: { status: 'changed', note: 'Brutal Impact now also cuts the Bash cooldown by 15 sec.' },
  },
  {
    id: 'hibernate',
    name: 'Hibernate',
