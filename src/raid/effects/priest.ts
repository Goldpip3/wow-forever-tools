...
export const PRIEST_EFFECTS: Effect[] = [
  ...
  },
  {
    ...
    providers: [{ classId: 'priest', specs: ANY }],
    forever: { status: 'same', note: 'Still trainable, sits in the Shadow Magic tab.' },
  },
  {
    id: 'fear-ward',
    name: 'Fear Ward',
  ...
  },
  {
    ...
    scope: 'self',
    categories: ['external-cooldowns'],
    providers: [{ classId: 'priest', specs: [DISC], talent: { tree: 'Discipline', name: 'Power Infusion' } }],
  ...
  },
  {
    ...
    providers: [
      { classId: 'priest', specs: [SHADOW], talent: { tree: 'Shadow Magic', name: 'Vampiric Embrace' } },
    ],
    forever: {
      status: 'changed',
  ...
  },
  {
    ...
    providers: [{ classId: 'priest', specs: [SHADOW], talent: { tree: 'Shadow Magic', name: 'Shadow Weaving' } }],
    forever: {
      status: 'changed',
  ...
  },
  {
    ...
    providers: [{ classId: 'priest', specs: [SHADOW], talent: { tree: 'Shadow Magic', name: 'Silence' } }],
    forever: { status: 'unverified' },
  },
  {
    id: 'shackle-undead',
  ...
  },
  {
    ...
    scope: 'raid',
    categories: ['armor'],
    providers: [{ classId: 'priest', specs: [HOLY], talent: { tree: 'Holy', name: 'Inspiration' } }],
    forever: {
      status: 'changed',
  ...
  },
  {
    ...
    scope: 'self',
    categories: ['external-cooldowns'],
    providers: [{ classId: 'priest', specs: [HOLY], talent: { tree: 'Holy', name: 'Prayer of Mending' } }],
    forever: { status: 'new', note: 'New Holy talent that jumps between party and raid members as it heals.' },
  },
  {
    id: 'penance',
    name: 'Penance',
    ...
    scope: 'self',
    categories: ['misc-utility'],
    providers: [{ classId: 'priest', specs: [DISC], talent: { tree: 'Discipline', name: 'Penance' } }],
    forever: { status: 'new', note: 'New Discipline talent that heals an ally or damages an enemy.' },
  },
  {
    id: 'lightwell',
    name: 'Lightwell',
    ...
    scope: 'self',
    categories: ['external-cooldowns'],
    providers: [{ classId: 'priest', specs: [HOLY], talent: { tree: 'Holy', name: 'Lightwell' } }],
  ...
  },
  {
    ...
    categories: ['external-cooldowns'],
    providers: [
      { classId: 'priest', specs: [HOLY], talent: { tree: 'Holy', name: 'Spirit of Redemption' } },
    ],
    forever: { status: 'changed', note: 'Duration and behaviour were adjusted in the demo tooltip.' },
  },
];
